...
export default function HeroWellness() {
    ...
    return (
        <section ref={ref} className="relative w-full bg-[#D7D7AA] py-16 px-20">
            <div className="flex flex-col lg:flex-row h-[90dvh] min-h-[600px] w-full overflow-hidden">
                ...
                >
                    {/* Top row */}
                    <motion.div
                        className="flex justify-between items-start px-8 lg:px-12 pt-24 lg:pt-10"
                    ...
                    <div className="flex-1 flex flex-col items-center justify-center px-8 lg:px-12">
                        ...
                        <motion.p
                            ...
                            animate={{ opacity: 1, y: 0 }}
                            transition={{ duration: 0.8, delay: 0.3 }}
                            className="mt-4 text-[#fff3e1] text-lg lg:text-xl italic pt-4"
