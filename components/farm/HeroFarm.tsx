        ...
        <section ref={ref} className="relative flex flex-col lg:flex-row h-dvh min-h-[700px] w-full overflow-hidden bg-[#1F1D1B]">
            ...
            >
                <motion.p
                    ...
                    className="text-sm tracking-[0.3em] text-[#D7D7AA] uppercase mb-6 lg:mb-8"
                ...
                <div className="overflow-hidden">
                    <motion.h1
                        ...
                        className="text-[#D7D7AA] leading-none tracking-tight"
                        style={{
                ...
                >
                    <p
                        className="text-[#D7D7AA]/90 text-lg lg:text-xl leading-relaxed mb-4"
                        style={{ fontFamily: "var(--font-serif)" }}
                    >
                        Huertos orgánicos, frutales y flores de temporada
                    </p>
                    <p
                        className="text-[#FFF3E1]/70 text-sm lg:text-base leading-relaxed"
                        style={{ fontFamily: "var(--font-sans)" }}
                    >
                        Una comunidad que consume lo que produce,
                        conectada a los ciclos de la tierra.
                    </p>
                </motion.div>
                ...
                >
                    ...
                    >
                        <span className="h-px w-8 bg-[#D7D7AA]/40 group-hover:w-12 transition-all duration-500" />
                        <span
            ...
            >
                <p
                    className="text-sm text-[#D7D7AA]/70"
                    style={{ fontFamily: "var(--font-sans)" }}
                >
