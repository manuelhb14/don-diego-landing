    ...
    return (
        <div id="proyecto">
            ...
            <section className="block md:hidden bg-[#fff8ed] pt-14">
                ...
                >
                    <p
                        className="text-[10px] tracking-[0.3em] text-[#AA7D69] uppercase mb-5 text-center"
                ...
                {/* Phase 1 — slide up, text bottom-left */}
                <motion.div
                ...
                {/* Phase 2 — slide up, text bottom-center */}
                <motion.div
                    initial={shouldReduceMotion ? false : { opacity: 0, y: 40 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true, margin: "0px" }}
                ...
                {/* Phase 3 — slide up, text bottom-right */}
                <motion.div
                    initial={shouldReduceMotion ? false : { opacity: 0, y: 40 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true, margin: "0px" }}
            ...
            >
                <div className="sticky top-0 h-screen w-full flex items-center justify-center overflow-hidden">
                    ...
                    <motion.div className="absolute top-[8%] left-[7%] w-52 md:w-56 lg:w-60 xl:w-72 aspect-[4/5] z-0" style={{ y: y1, opacity: imgOp1 }}>
                    ...
                    <motion.div className="absolute top-[17%] right-[7%] md:right-[7%] lg:right-[10%] w-48 md:w-52 lg:w-56 xl:w-64 aspect-square z-0" style={{ y: y4, opacity: imgOp4 }}>
                    ...
                    <motion.div className="absolute top-[37%] -right-[6%] md:-right-[2%] lg:right-[4%] w-52 md:w-64 lg:w-72 xl:w-80 aspect-[3/4] z-0" style={{ y: y2, opacity: imgOp2 }}>
                    ...
                    <motion.div className="absolute top-[59%] left-[-3%] md:left-[1%] lg:left-[8%] w-60 md:w-72 lg:w-80 xl:w-96 aspect-[4/3] z-0" style={{ y: y5, opacity: imgOp5 }}>
                    ...
                    <motion.div className="absolute bottom-[0%] md:bottom-[-3%] left-[4%] md:left-[15%] lg:left-[20%] w-60 md:w-72 lg:w-80 xl:w-96 aspect-video z-0 origin-bottom-left" style={{ y: y3, opacity: imgOp3 }}>
                    ...
                    <motion.div className="absolute bottom-[8%] md:bottom-[5%] right-[2%] md:right-[6%] lg:right-[2%] w-56 md:w-64 lg:w-64 xl:w-80 aspect-[4/3] z-0 origin-bottom-right" style={{ y: y6, opacity: imgOp6 }}>
