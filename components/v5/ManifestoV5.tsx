...
export default function ManifestoV5() {
    ...
    // 0.0 - 0.2: Scroll in "Con la Tierra"
    // 0.3 - 0.5: Scroll in "Con la Comunidad"
    // 0.6 - 0.8: Scroll in "Con uno Mismo"

    const tierraOpacity = useTransform(textScrollProgress, [0, 0.2, 1], [0, 1, 1]);
    const comunidadOpacity = useTransform(textScrollProgress, [0.3, 0.5, 1], [0, 1, 1]);
    const mismoOpacity = useTransform(textScrollProgress, [0.6, 0.8, 1], [0, 1, 1]);
    ...
    // Group 1: With "Con la Tierra" (0.0 - 0.2)
    const op1 = useTransform(textScrollProgress, [0, 0.2, 1], [0, 1, 1]);
    const op4 = useTransform(textScrollProgress, [0.05, 0.25, 1], [0, 1, 1]);

    // Group 2: With "Con la Comunidad" (0.3 - 0.5)
    const op2 = useTransform(textScrollProgress, [0.3, 0.5, 1], [0, 1, 1]);
    const op5 = useTransform(textScrollProgress, [0.35, 0.55, 1], [0, 1, 1]);

    // Group 3: With "Con uno Mismo" (0.6 - 0.8)
    const op3 = useTransform(textScrollProgress, [0.6, 0.8, 1], [0, 1, 1]);
    const op6 = useTransform(textScrollProgress, [0.65, 0.85, 1], [0, 1, 1]);
    ...
    return (
        <section
            ...
            style={{ height: "300vh" }} // Tall enough for comfortable scrolling
        >
