        ...
        <section id="services" className="bg-[#FFF3E1] text-[#222222] overflow-hidden relative">
            <div className="max-w-[1440px] mx-auto w-full py-12 lg:py-24 px-6 md:px-10 lg:px-16 flex flex-col">
                ...
                <div className="w-full flex justify-between items-end mb-4 lg:mb-8">
                    ...
                    >
                        <p className="text-[#222]/80 text-[14px] md:text-[15px] leading-[1.8] font-normal tracking-[0.01em] w-[350px] text-right">
                ...
                >
                    <p className="text-[#222]/80 text-[14px] md:text-[15px] leading-[1.8] font-normal tracking-[0.01em] w-full">
                        Don Diego Club Residencial se estructura en torno a cuatro componentes con
                        identidad propia, integrados en una visión coherente de comunidad y territorio.
                    </p>
                </motion.div>
                ...
                <div className="w-full flex flex-col">
                    <div className="flex flex-col md:flex-row justify-between gap-6 md:gap-4 lg:gap-8 items-start w-full">
                        ...
                        >
                            <div className="relative w-full aspect-[4/3] md:aspect-[2/3] group cursor-pointer overflow-hidden rounded-sm">
                                <Image
                        ...
                        >
                            <div className="relative w-full aspect-[4/3] md:aspect-[3/4] group cursor-pointer overflow-hidden rounded-sm">
                                <Image
                    ...
                    <div className="flex justify-end mt-10 md:mt-24 w-full mb-12 md:mb-0">
                        <motion.div
                            initial={{ opacity: 0, y: 20 }}
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true }}
                            transition={{ duration: 0.8, delay: 0.4 }}
                            className="w-full sm:w-[60%] lg:w-[50%] flex flex-col items-start"
                        >
                            <p className="text-[#222]/80 text-[14px] md:text-[15px] leading-[1.8] font-normal tracking-[0.01em] mb-8">
