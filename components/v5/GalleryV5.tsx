...
const galleryItems = [
    ...
    { src: "/images/gallery/gallery-1.png", alt: "Interior", title: "INTERIORISMO - MATERIALES Y TEXTURAS", description: "Mobiliario seleccionado meticulosamente que resalta la artesanía y el uso de materiales rústicos integrados con un diseño atemporal.", borderColor: "#9A6A4E" },
    { src: "/images/gallery/gallery-4.png", alt: "Sala de estar", title: "SALA DE ESTAR - ILUMINACIÓN NATURAL", description: "Acabados en tonos cálidos y detalles sutiles que aportan un ritmo táctil y un encanto atemporal a los interiores modernos.", borderColor: "#B58D6A" },
...
export default function GalleryV5() {
    ...
    return (
        <>
            <section id="galeria" className="bg-[#FFF3E1] pt-2 lg:pt-28 pb-6 lg:pb-28 overflow-hidden">
                ...
                {/* Carousel */}
                <div
                    className="relative w-full h-[55vh] md:h-[65vh] max-h-[600px] md:max-h-[700px] flex items-center justify-center mb-10 md:mb-16"
                ...
                <div className="max-w-[800px] mx-auto px-6 text-center min-h-[160px]">
                    <AnimatePresence mode="wait">
                        ...
                        >
                            <h3
                                className="text-[11px] md:text-[13px] tracking-[0.2em] md:tracking-[0.3em] text-[#222] uppercase mb-6 md:mb-8"
                                style={{ fontFamily: "var(--font-sans)" }}
                            >
                                {galleryItems[currentIndex].title}
                            </h3>
                            <p
                                className="text-[#222]/80 text-[14px] md:text-[15px] leading-[1.8] font-normal tracking-[0.01em]"
                                style={{ fontFamily: "var(--font-sans)" }}
                            >
