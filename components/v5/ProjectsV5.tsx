        ...
        >
            ...
            >
                <div className="max-w-2xl">
                    ...
                    {/* Description */}
                    <motion.p
                        className="text-white text-sm lg:text-base leading-relaxed max-w-md mb-4 md:mb-8"
                        style={{
                            ...
                            return (
                                <div key={idx} className="flex items-center gap-3">
                                    <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center shrink-0">
                                        <Icon size={14} className="text-white/90" strokeWidth={1.5} />
                                    </div>
                                    <span
...
export default function ProjectsV5() {
