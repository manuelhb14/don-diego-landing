                                ...
                                <form onSubmit={handleSubmit} className="relative z-10 space-y-6">
                                    ...
                                    <div className="flex flex-col gap-3 pt-2 sm:flex-row">
                                        <button
                                            type="submit"
                                            disabled={loading}
                                            className="w-full flex-1 bg-[#AA7D69] px-4 py-4 text-[11px] font-bold tracking-[0.2em] text-[#FFF9F2] uppercase transition-colors duration-300 hover:bg-[#956955] disabled:cursor-not-allowed disabled:opacity-60"
                                            style={{ fontFamily: "var(--font-sans)" }}
                                        >
                                        ...
                                        <a
                                            ...
                                            className="flex w-full flex-1 items-center justify-center gap-3 border border-[#2f8f4f] bg-[#1faa52]/85 px-4 py-4 text-[11px] font-bold tracking-[0.2em] text-[#ffffff] uppercase transition-colors duration-300 hover:border-[#1f7f40] hover:bg-[#1f9a47]"
                                            style={{ fontFamily: "var(--font-sans)" }}
                                        >
                                    ...
                                    <p className="pt-3 text-center text-[10px] text-[#1C1713]/48" style={{ fontFamily: "var(--font-sans)" }}>
                                        {t("privacy")}
                                    </p>
                                </form>
                            )}
