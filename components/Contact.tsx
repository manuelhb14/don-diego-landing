                            ...
                            {submitted ? (
                                ...
                                <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div className="flex flex-col gap-2">
                                            ...
                                            <input
                                                type="text"
                                                required
                                                className="w-full bg-transparent border-b border-[#E6E1D6]/20 py-3 text-[#E6E1D6] placeholder-[#E6E1D6]/30 text-base outline-none focus:border-[#E1B19B] transition-colors"
                                                style={{ fontFamily: "var(--font-sans)" }}
                                    ...
                                    <div className="pt-4 flex flex-col md:flex-row items-center justify-between gap-4">
                                        <button
                                            type="submit"
                                            className="w-full md:flex-1 bg-[#E1B19B] hover:bg-[#d4a48e] text-[#111] px-4 py-4 text-[11px] font-bold uppercase tracking-[0.2em] transition-colors duration-300 rounded-sm whitespace-nowrap"
                                            style={{ fontFamily: "var(--font-sans)" }}
                                        >
                                            Agendar visita
                                        </button>
